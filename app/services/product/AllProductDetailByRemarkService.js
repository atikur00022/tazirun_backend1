export const AllProductDetailByRemarkService = async (Request, DataModel, MatchQuery, SearchArray, JoinStage1, JoinStage2, UnwindBrandStage1, UnwindBrandStage2, Projection) => {
